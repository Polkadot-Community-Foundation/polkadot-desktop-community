...
Feature: Main View
  ...
  @allure.id:14686
  Scenario: TC-1.3.1 Dashboard displays after skipping onboarding
  ...
  @allure.id:14679
  Scenario: TC-1.1.5 Dashboard displays correctly in fullscreen
    Given the app is launched
  ...
  @allure.id:14857
  Scenario: TC-7.6.4 Open quick chat
    Given the app is launched
    And the user skips onboarding
  ...
  @allure.id:14904
  Scenario: TC-10.3.1 Open user card
    Given the app is launched
    And the user skips onboarding
