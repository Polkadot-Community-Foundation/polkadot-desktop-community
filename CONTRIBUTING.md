...
3. Install a correct node version with `nvm use`
4. Install the development dependencies with `npm run install`
5. Make your changes on a new branch, preferably with a name that describes the changes you are making
