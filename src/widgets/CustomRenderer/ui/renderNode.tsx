...
import { type ActionHandler, type CustomNode } from '../types';
...
const COLOR_TOKEN_CSS: Record<CodecType<typeof ColorToken>, string> = {
  ...
  'bg.surface.main': 'var(--bg-surface-main)',
  'bg.surface.container': 'var(--bg-surface-container)',
  'bg.surface.nested': 'var(--bg-surface-nested)',
 ...
 */
export function renderNode(node: CustomNode, onAction: ActionHandler, key?: string | number): ReactNode {
  switch (node.tag) {
    case 'Nil':
      return null;
