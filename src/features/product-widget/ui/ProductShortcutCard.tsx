...
import { type Icon, useDotNsLabels, usePersistedProductById } from '@/domains/product';
import { ShortcutIcon } from '@/features/dashboard';
...
export const ProductShortcutCard = memo(({ productId }: Props) => {
  ...
  const displayLabel = product ? labels.shortLabel(product.baseName) : productId;
