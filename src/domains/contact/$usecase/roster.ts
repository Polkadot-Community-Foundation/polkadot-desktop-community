 ...
 * every known contact (see `contactService.computeRosterTopic`). Statements arriving on those
...
const startRosterSubscriber = (deps: RosterSubscriberDeps): VoidFunction => {
