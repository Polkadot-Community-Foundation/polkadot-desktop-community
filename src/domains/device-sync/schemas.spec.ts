...
describe('LocalDeviceCodec', () => {
  it('round-trips active device with explicit DeviceStatus enum', () => {
    ...
    const enc = new Uint8Array(32).fill(0x02);
    const device = {
    ...
    // status byte sits after 32+32 = 64 bytes (32-byte X25519 key)
    expect(encoded[64]).toBe(0); // ACTIVE discriminant
...
describe('SyncMessage cross-codec fixture', () => {
  it('encodes a Update with one of each entity to the canonical byte sequence', () => {
    ...
    // NOT yet re-confirmed against Android — treat as unverified.
    const expectedHex =
      '';
