  ...
  return (
    ...
    >
      <div className="flex max-w-4xl flex-col items-center text-center">
        <h1 className="w-full text-[48px] leading-16 font-semibold tracking-[-1px] text-fg-primary">
          {t('common.web3summitEnded.title')}
        </h1>
        <p className="w-full text-[48px] leading-16 font-semibold tracking-[-1px] text-fg-primary">
